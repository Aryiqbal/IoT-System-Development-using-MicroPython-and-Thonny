...
def log_to_google_sheets(temperature):
    ...
    for temp in temperature:
        payload = {"temperature": temp, "location": "Outdoor"}
...
print("Collecting outdoor temperature data...")
outdoor_temperature = []
for _ in range(10):
    temperature, _, _ = bme.read_compensated_data()
    outdoor_temperature.append(temperature / 100)
    print("Temperature:", temperature / 100)  
    time.sleep(10)

print("Outdoor temperature data collected:", outdoor_temperature)

log_to_google_sheets(outdoor_temperature)
